  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-b from-background/80 to-background">
      <div className="w-full max-w-md mt-16 sm:mt-0">
        <Link
          href="/"
          className="absolute top-4 left-4 flex items-center text-sm text-muted-foreground hover:text-foreground z-20 px-3 py-2 rounded-full backdrop-blur-md bg-background/80"
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to home
        </Link>

        <Card className="w-full border border-purple-300/20 backdrop-blur-sm bg-background/80 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-500 to-indigo-500"></div>
